...
export const accountReducer = (state = initialState, action: AccountAction): AccountState => {
    switch (action.type) {
        case AccountActionTypes.LOGIN_USER:
            return { loading: true, error: null, isLogined: false, accessToken: "", expire: null };
        ...
        case AccountActionTypes.LOGIN_USER_ERROR:
            ...
            return { loading: false, error: action.payload, isLogined: false, accessToken: "", expire: null };
        case AccountActionTypes.LOGIN_USER_RESET:
            return { loading: false, error: null, isLogined: false, accessToken: "", expire: null };
        default:
            return state;
    }
}
